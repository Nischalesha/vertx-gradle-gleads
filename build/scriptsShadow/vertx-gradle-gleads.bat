...
set CLASSPATH=%APP_HOME%\lib\vertx-gradle-gleads-1.0.0-SNAPSHOT-fat.jar

@rem Execute vertx-gradle-gleads
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %VERTX_GRADLE_GLEADS_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
